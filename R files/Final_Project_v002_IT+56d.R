...
cFRA2 <- ts(covid_data$Cdeaths_IT[53:125],start=2020+53/365, frequency=365) #t=0 @ day69. +56d
...
write.csv(cFRA2_tbats_pred, file = "IT no lockdown+56d BATS.csv") # export the selected model's predictions into a CSV file
