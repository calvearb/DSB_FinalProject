...
cFRA2 <- ts(covid_data$Cdeaths_UK[66:139],start=2020+66/365, frequency=365) #t=0 @ day83. +56d
...
write.csv(cFRA2_AAN_pred, file = "UK no lockdown+56d (AAN).csv") # export the selected model's predictions into a CSV file

par(mfrow=c(1,1)) # This command sets the plot window to show 1 row of 4 plots
plot(cFRA2_AAN_pred, xlab="Year", ylab="Accumulated deaths", ylim=c(0,60000))
lines(cFRA3, col="red")
