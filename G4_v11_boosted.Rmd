...
### Italy deaths analysis 14 days post lockdown  
...
### France deaths analysis 14 days post lockdown
...
# Export the results out
write.csv(cFRA_14_tbats_pred, file = "FRA no lockdown+14d (MMND) .csv") # export the selected model's predictions into a CSV file
...
### UK deaths analysis 14 days post the lockdown 
...
# Export the results out
write.csv(cUK_14_ARIMA_pred, file = "UK no lockdown+14d (MMND) .csv") # export the selected model's predictions into a CSV file
...
### Italy deaths analysis 28 days post lockdown  
...
#par(mfrow=c(3,2)) # This command sets the plot window to show 1 row of 4 plots
#plot(cIT_28_AAN_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cIT_F, col="red")
#plot(cIT_28_MMN_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cIT_F, col="red")
#plot(cIT_28_AAND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cIT_F, col="red")
#plot(cIT_28_MMND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cIT_F, col="red")
#plot(cIT_28_tbats_pred, xlab="Year", ylab="Predicted Electric Rate", ylim=c(0,100000))
#lines(cIT_F, col="red")
#plot(cIT_28_ARIMA_pred, ylim=c(0,100000))
#lines(cIT_F, col="red")
...
f_AANF  <- function(y, h) forecast(ets(y, model="AAN"), h = h)
errors_AANF <- tsCV(cIT_28, f_AANF, h=1, window=15)

f_MMNF<- function(y, h) forecast(ets(y, model="MMN"), h = h)
errors_MMNF <- tsCV(cIT_28, f_MMNF, h=1, window=15)

f_AAND  <- function(y, h) forecast(ets(y, model="AAN", damped=TRUE), h = h)
errors_AAND <- tsCV(cIT_28, f_AAND, h=1, window=15)

f_MMND  <- function(y, h) forecast(ets(y, model="MMN", damped=TRUE), h = h)
errors_MMND <- tsCV(cIT_28, f_MMND, h=1, window=15)

f_TBATS  <- function(y, h) forecast(tbats(y), h = h)
errors_TBATS <- tsCV(cIT_28, f_TBATS, h=1, window=15)

f_ARIMA  <- function(y, h) forecast(auto.arima(y), h = h)
errors_ARIMA <- tsCV(cIT_28, f_ARIMA, h=1, window=15)
...
# Export the results out
write.csv(cIT_28_MMND_pred, file = "IT no lockdown+28d (MMND) .csv") # export the selected model's predictions into a CSV file

plot(cIT_28_MMND_pred, xlab="Year", ylab="Italy Acummulated deaths", ylim=c(0,250000))
lines(cIT_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
...
### France deaths analysis 28 days post lockdown
...
#P=15 #predicted days, à supprimer? 
#cFRA <- ts(covid_data$Cdeaths_IT,start=0, frequency=1)
cFRA_28 <- ts(covid_data$Cdeaths_IT[58:103],start=t0, frequency=365) #t=0 @ day75. +28d 
cFRA_F <- ts(covid_data$Cdeaths_IT[58:288],start=t0, frequency=365)   # a supprimer?

#plot(cFRA_F)
#lines(cFRA_28, col="red")
...
#plot(cFRA_28_ARIMA_pred)
#lines(cFRA_F, col="red")

#par(mfrow=c(3,2)) # This command sets the plot window to show 1 row of 4 plots
#plot(cFRA_28_AAN_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cFRA_F, col="red")
#plot(cFRA_28_MMN_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cFRA_F, col="red")
#plot(cFRA_28_AAND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cFRA_F, col="red")
#plot(cFRA_28_MMND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cFRA_F, col="red")
#plot(cFRA_28_tbats_pred, xlab="Year", ylab="Predicted Electric Rate", ylim=c(0,100000))
#lines(cFRA_F, col="red")
#plot(cFRA_28_ARIMA_pred, ylim=c(0,100000))
#lines(cFRA_F, col="red")
...
f_AANF  <- function(y, h) forecast(ets(y, model="AAN"), h = h)
errors_AANF <- tsCV(cFRA_28, f_AANF, h=1, window=10)

f_MMNF<- function(y, h) forecast(ets(y, model="MMN"), h = h)
errors_MMNF <- tsCV(cFRA_28, f_MMNF, h=1, window=10)

f_AAND  <- function(y, h) forecast(ets(y, model="AAN", damped=TRUE), h = h)
errors_AAND <- tsCV(cFRA_28, f_AAND, h=1, window=10)

f_MMND  <- function(y, h) forecast(ets(y, model="MMN", damped=TRUE), h = h)
errors_MMND <- tsCV(cFRA_28, f_MMND, h=1, window=10)

f_TBATS  <- function(y, h) forecast(tbats(y), h = h)
errors_TBATS <- tsCV(cFRA_28, f_TBATS, h=1, window=10)

f_ARIMA  <- function(y, h) forecast(auto.arima(y), h = h)
errors_ARIMA <- tsCV(cFRA_28, f_ARIMA, h=1, window=10)
...
# Export the results out
write.csv(cFRA_28_ARIMA_pred, file = "FRA no lockdown+28d (ARIMA) .csv") # export the selected model's predictions into a CSV file

plot(cFRA_28_ARIMA_pred, xlab="Year", ylab="France Acummulated deaths", ylim=c(0,250000))
lines(cFRA_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
...
### UK deaths analysis 28 days post the lockdown 
...
#P=15 #predicted days, à supprimer? 
#cUK <- ts(covid_data$Cdeaths_IT,start=0, frequency=1)
cUK_28 <- ts(covid_data$Cdeaths_IT[68:112],start=t0, frequency=365) #t=0 @ day84. +28d 
cUK_F <- ts(covid_data$Cdeaths_IT[68:288],start=t0, frequency=365)   # a supprimer?
...
#par(mfrow=c(3,2)) # This command sets the plot window to show 1 row of 4 plots
#plot(cUK_28_AAN_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cUK_F, col="red")
#plot(cUK_28_MMN_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cUK_F, col="red")
#plot(cUK_28_AAND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cUK_F, col="red")
#plot(cUK_28_MMND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,100000))
#lines(cUK_F, col="red")
#plot(cUK_28_tbats_pred, xlab="Year", ylab="Predicted Electric Rate", ylim=c(0,100000))
#lines(cUK_F, col="red")
#plot(cUK_28_ARIMA_pred, ylim=c(0,100000))
#lines(cUK_F, col="red")
...
f_AANF  <- function(y, h) forecast(ets(y, model="AAN"), h = h)
errors_AANF <- tsCV(cUK_28, f_AANF, h=1, window=10)

f_MMNF<- function(y, h) forecast(ets(y, model="MMN"), h = h)
errors_MMNF <- tsCV(cUK_28, f_MMNF, h=1, window=10)

f_AAND  <- function(y, h) forecast(ets(y, model="AAN", damped=TRUE), h = h)
errors_AAND <- tsCV(cUK_28, f_AAND, h=1, window=10)

f_MMND  <- function(y, h) forecast(ets(y, model="MMN", damped=TRUE), h = h)
errors_MMND <- tsCV(cUK_28, f_MMND, h=1, window=10)

f_TBATS  <- function(y, h) forecast(tbats(y), h = h)
errors_TBATS <- tsCV(cUK_28, f_TBATS, h=1, window=10)

f_ARIMA  <- function(y, h) forecast(auto.arima(y), h = h)
errors_ARIMA <- tsCV(cUK_28, f_ARIMA, h=1, window=10)
...
# Export the results out
write.csv(cUK_28_ARIMA_pred, file = "UK no lockdown+28d (MMND) .csv") # export the selected model's predictions into a CSV file

plot(cUK_28_ARIMA_pred, xlab="Year", ylab="UK Acummulated deaths", ylim=c(0,250000))
lines(cUK_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
