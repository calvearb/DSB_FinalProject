...
#expfore<-exp(cIT_14_ARIMA_pred$forecast)
par(mfrow=c(1,1)) # This command sets the plot window to show 1 row of 4 plots
plot(cIT_14_AAND_pred, xlab="Year", ylab="Acummulated deaths", ylim=c(0,20))
lines(cIT_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
...
# Export the results out
write.csv(cFRA_14_MMND_pred, file = "FRA no lockdown+14d (MMND) incl(ARIMA).csv") # export the selected model's predictions into a CSV file
...
```
After 14 days of lockdown, the results for all countries are: 
...
#expfore<-exp(cIT_14_ARIMA_pred$forecast)
par(mfrow=c(3,1)) 
plot(cIT_14_MMND_pred, xlab="Year", ylab="Italy Acummulated deaths", ylim=c(0,200000))
lines(cIT_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)

plot(cFRA_14_MMND_pred, xlab="Year", ylab="France Acummulated deaths", ylim=c(0,200000))
lines(cFRA_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)

plot(cUK_14_ARIMA_pred, xlab="Year", ylab="UK Acummulated deaths", ylim=c(0,200000))
lines(cUK_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
