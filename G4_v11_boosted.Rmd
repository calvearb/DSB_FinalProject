...
We can also think and verify that just before the lockdown, the deaths were exponential so we can create an exponential growth models
...
plot(cUK_14_ARIMA_pred, xlab="Year", ylab="UK Acummulated deaths", ylim=c(0,100000))
lines(cUK_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
...
plot(cIT_28_MMND_pred, xlab="Year", ylab="Italy Acummulated deaths", ylim=c(0,100000))
lines(cIT_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
...
plot(cFRA_28_ARIMA_pred, xlab="Year", ylab="France Acummulated deaths", ylim=c(0,100000))
lines(cFRA_F, col="red")
abline(v=2020+69/365, col="green")
legend("left", legend=c("Best fitted model","Real death toll", "Start of Lockdown"), col=c("blue", "red","green"), lty=1)
